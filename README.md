...
В открывшемся окне: 'Введите полный путь к директории, в который надо подсчитать количество файлов: '" введите полный путь, к примеру:
C:\Users\ivano\Desktop\Project1\Proba
Далее откроется окно: 
'Введите параметр для вложенных папок "--recursive": '
введите с клавиатуры "--recursive"

'### 6. Установщик даты к  имени файлов  '
...
В открывшемся окне: 'Введите полный путь к директории, выбранной для анализа: ' введите полный путь к директории, к примеру:
C:\Users\ivano\Desktop\Project1\Total
